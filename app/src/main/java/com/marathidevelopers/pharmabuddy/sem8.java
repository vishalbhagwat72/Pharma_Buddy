...
public class sem8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UnityAds.initialize(sem8.this, GameID, testMode);
        ...
        cookies = CookieManager.getInstance().getCookie("https://drive.google.com/drive/folders/1n9KyJbiotwj5HtXVLYWagzrXJIo-7E_3?usp=sharing");
...
//
    ...
    private void DisplayInterstitialAd() {
        if (UnityAds.isReady(interstitialAdPlacement)) {
            UnityAds.show(sem8.this, interstitialAdPlacement);
        }
    }
}