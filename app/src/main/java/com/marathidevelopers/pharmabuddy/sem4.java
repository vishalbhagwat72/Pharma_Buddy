...
public class sem4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UnityAds.initialize(sem4.this, GameID, testMode);
        ...
        cookies = CookieManager.getInstance().getCookie("https://drive.google.com/drive/folders/19QpNFb1DGBTAVa3eZK-mPuIb7jQ0WwNV?usp=sharing");
...
//
    ...
    private void DisplayInterstitialAd() {
        if (UnityAds.isReady(interstitialAdPlacement)) {
            UnityAds.show(sem4.this, interstitialAdPlacement);
        }
    }}