...
public class sem5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UnityAds.initialize(sem5.this, GameID, testMode);
        ...
        cookies = CookieManager.getInstance().getCookie("https://drive.google.com/drive/folders/1d1woXe83HOnIXs8Drz5fJQr9t4bE1TLj?usp=sharing");
...
//
    ...
    private void DisplayInterstitialAd() {
        if (UnityAds.isReady(interstitialAdPlacement)) {
            UnityAds.show(sem5.this, interstitialAdPlacement);
        }
    }}